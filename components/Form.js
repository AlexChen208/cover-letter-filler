  ...
  return (
    <div className={styles.form_container}>
      ...
      <Tooltip
        ...
        <IconButton>
          <Image
            ...
            height={50}
            alt='Google Docs'
            onClick={() => {window.open('https://docs.google.com/document/d/1pmeDCiAl1s6bGtzDrC-j7fz34Q4ifYZsu33BjoeKd-g/edit?usp=sharing')}}
            />
        </IconButton>
      </Tooltip>
      ...
      >
        ...
        My name is Alex Chen and I am a Full Stack Software Engineer with a kinesiology background. I am applying for the {position} position. I believe that I am a strong fit for {company}’s unique culture and would bring to the company my technical and interpersonal competence.<br/><br/>
