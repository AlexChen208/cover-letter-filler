  ...
  return (
    <div className={styles.form_container}>
      ...
      >
        ...
        My name is Alex Chen and I am a Full Stack Software Engineer with a kinesiology background. I am applying for the {position} position that I learned about from {event}. I believe that I am a strong fit for {company}’s unique culture and would bring to the company my technical and interpersonal competence.<br/><br/>
